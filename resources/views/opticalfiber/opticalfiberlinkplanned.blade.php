...
@section('content')
    @include('opticalfiber.filters.opticalfiberlinksplanned_filter')
    ...
    <div class="card mb-5">
        ...
        <div class="card-body">
            ...
            @include('opticalfiber.exports.opticalfiberlinkplanned_export')
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#OFL_table').DataTable(
                {
                    ...
                    "columnDefs":
                    [{
                        className: "align-right", "targets": [6,7,8]
                    }],
            ...
            $('.filter-input').change(function() {
                ...
                var base_url = '{{Config::get('geo.GEO_URL')}}/nepal_map/wfs?request=GetFeature&service=WFS&version=1.0.0&typeName=nepal_map:opticalfiberlinkplans_new+&authkey={!! Config::get('geo.GEO_AUTHKEY') !!}'
