...
<div class="card mb-5">
    ...
    <div class="card-body">
        ...
        @include('opticalfiber.exports.opticalfiber_export')
        <div class="table-responsive">
            {{-- Table info --}}
            <table id="OFS_table" class="table table-bordered table-striped">
                <thead>
                    <tr>
                    <tr>
                        {{-- Table Headers --}}
...
<script>
    $(document).ready(function()
    {
        ...
        $('.filter-input').change(function() {
            ...
            var base_url = '{{Config::get('geo.GEO_URL')}}/nepal_map/wfs?request=GetFeature&service=WFS&version=1.0.0&typeName=nepal_map:opticalfibers_new+&authkey={!! Config::get('geo.GEO_AUTHKEY') !!}'
