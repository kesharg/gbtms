{{-- <script>
    var ncell2gfromController=
                    ...
                    var DataBycoverageChart= new Chart(document.getElementById("geographic_penetration_chart"), {
                        type: "bar",
                        data: {
                    ...
                    function updatencell2g(){
                        ...
                        DataBycoverageChart.options.title.text="Coverage area of 2G per province(km²)";
                        DataBycoverageChart.update();
                    }
                    function updatencell3g(){
