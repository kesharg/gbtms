...
@section('content')
@include('microwave.microwave_filter')

<div class="card mb-5">
    <div class="card-header">
        {{-- Card Head --}}
        <h2>Microwave Station</h2>
    </div>
    <div class="card-body">

        @include('microwave.microwave_export')
        <div class="table-responsive">
            {{-- Table info --}}
            <table id="MWS_table" class="table table-sm table-bordered table-striped" width="100%">
                <thead>
                    <tr>
                        {{-- Table Headers --}}
...
<script>
    ...
    var table= $('#MWS_table').DataTable(
        ...
        $('.filter-input').change(function() {
            ...
            var base_url = '{!! Config::get('geo.GEO_URL')!!}/nepal_map/wfs?request=GetFeature&service=WFS&version=1.0.0&typeName=nepal_map:microwaves+&authkey={!! Config::get('geo.GEO_AUTHKEY') !!}'
            ...
            if (station) {
                cql_param += " AND strToLowerCase(mwstnname) ILIKE'%" + station.toLowerCase()  + "%'";
            }
