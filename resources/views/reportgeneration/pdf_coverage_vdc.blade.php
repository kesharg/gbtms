...
<html>
    ...
    <body>
        ...
        <div style="margin-top:-100px;">
            <h2 style="text-align: center;">NTA VDC Coverage Data Report</h2>
        ...
        <table>
            ...
            @for($i=1;$i<=count($vdc_name);$i++) <tr>
                <td class="text-right">{{ $i }}</td>
                <td>{{ $vdc_name[$i] }}</td>
                <td class="text-right">{{ $vdc_area[$i] }}</td>
                <td class="text-right">{{ (int)($coverage_area_vdc[$i]/1000000)}}</td>
