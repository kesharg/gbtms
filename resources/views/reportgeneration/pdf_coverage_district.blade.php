...
<html>
    ...
    <body>
        ...
        <div style="margin-top:-100px;">
            <h2 style="text-align: center;">NTA District Coverage Data Report</h2>
        ...
        <table>
            ...
            @for($i=1;$i<=count($district_name);$i++) <tr>
                ...
                <td class="text-right">{{ $district_area[$i] }}</td>
                <td class="text-right">{{ (int)($coverage_area_district[$i]/1000000)}}</td>
