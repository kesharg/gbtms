...
<html>
    ...
    <body>
        ...
        <div style="margin-top:-100px;">
            <h2 style="text-align: center;">NTA Province Coverage Data Report</h2>
        ...
        <table>
            ...
            <tr>
                <th>SN.</th>
                <th>Province Name</th>
                <th>Province Area(km²)</th>
                <th>Coverage Area(km²)</th>
                <th>Percentage</th>
            </tr>
            @for($i=1;$i<=count($province_name);$i++) <tr>
                <td class="text-right">{{ $i }}</td>
                <td>{{ $province_name[$i] }}</td>
                <td class="text-right">{{ $province_area[$i] }}</td>
                <td class="text-right">{{ (int)($coverage_area_province[$i]/1000000)}}</td>
